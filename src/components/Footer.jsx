...
export default function Footer() {
  ...
  return (
    <footer className="bg-white dark:bg-[#2a4247] ">
      ...
      <div className="mx-auto w-full max-w-screen-xl">
        ...
        <div className="px-4 py-6 bg-gray-100 dark:bg-[#a1a7e038] md:flex md:items-center md:justify-between">
          ...
          >
            ...
            <a
              className="t cursor-pointerext-gray-400 hover:text-gray-900 dark:hover:text-white"
              aria-label="Discord"
            >
              <svg
                className="w-6 h-6"
