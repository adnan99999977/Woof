...
const WinterDietGuideUnique = () => {
  return (
    <section className="pt-16">
      <h2 className="lg:text-6xl text-4xl w-8/12 mx-auto font-extrabold text-center mb-16 text-[#1e293b]">
        Winter Diet Guide for Pets
      </h2>

      <div className="flex flex-col gap-8 lg:gap-16 w-[80%] lg:max-w-6xl mx-auto">
        {dietTips.map((tip, index) => (
          ...
          >
            ...
            <motion.div
              className="flex-shrink-0 w-20 lg:w-32 h-20 lg:not-only-of-type:h-32 rounded-full flex items-center justify-center text-4xl bg-white shadow-lg"
            ...
            <div className="text-center md:text-left">
              <h3 className="lg:text-2xl text-xl font-bold mb-2 text-[#1e293b]">
                {tip.title}
              </h3>
              <p className="text-gray-700 text-sm lg:text-lg">{tip.description}</p>
            </div>
